...
def source_script() -> Path:
    return repo_root() / "notebooks_adapted" / "build_lincs_l1000_chempert_gmt_only.py"


def load_source_module(script_path: Path):
    spec = importlib.util.spec_from_file_location("lincs_l1000_chempert_source", script_path)
