...
HARMONIZOME_PIGEAN_FILE = "../../data/gtex/output.tissue.pigean/harmonizome_pigean_validation.txt"
...
def main(source):
    ...
    if source == "harmonizome":
        ...
        sources = ["GTEx_XMT_2022-06-06_GTEx_Aging_Signatures_2021.gmt"]
        client = "pigean"
    elif source == "harmonizome_pigean":
        out_file = HARMONIZOME_PIGEAN_FILE
        sources = ["harmonizome_gtex_aging.gmt"]
        client = "pigean"
