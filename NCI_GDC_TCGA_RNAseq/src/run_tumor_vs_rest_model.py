...
def build_workflow_cmd(*, python_bin, workflow_out, organism, genome_build, project_id, counts_tsv, sample_metadata_tsv, group_column, settings, provenance_mirror_local_prefix, provenance_mirror_remote_prefix, upstream_provenance_graph_json=None) -> list[str]:
    cmd = [
