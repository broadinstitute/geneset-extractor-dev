...
Use all-samples modern DE with raw-p directional ranking and selected-source GMT export.
...
```bash
bash run/gtex_model_sweep_v1/run_model_modern_signedp250_selected.v1.sh
```

## Expected Outputs

- named_model_gmt_gz: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/modern_signedp250_selected/modern_signedp250_selected.v1.gmt.gz`
- comparison_to_reference_tsv: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/modern_signedp250_selected/comparison_to_reference.v1.tsv`
- comparison_to_reference_md: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/modern_signedp250_selected/comparison_to_reference.v1.md`

## Rationale

Tests whether raw p-value ordering within an FDR-filtered set better preserves subtle age-associated rankings.
