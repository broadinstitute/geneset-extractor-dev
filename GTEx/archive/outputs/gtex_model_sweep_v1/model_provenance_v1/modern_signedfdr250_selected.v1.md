# modern_signedfdr250_selected v1
...
Use all-samples modern DE but harmonizome-like directional FDR ranking and selected-source GMT emission.
...
```bash
bash run/gtex_model_sweep_v1/run_model_modern_signedfdr250_selected.v1.sh
```

## Expected Outputs

- named_model_gmt_gz: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/modern_signedfdr250_selected/modern_signedfdr250_selected.v1.gmt.gz`
- comparison_to_reference_tsv: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/modern_signedfdr250_selected/comparison_to_reference.v1.tsv`
- comparison_to_reference_md: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/modern_signedfdr250_selected/comparison_to_reference.v1.md`

## Rationale

Separates harmonizome-like ranking/export behavior from harmonizome-mode DE fitting.
