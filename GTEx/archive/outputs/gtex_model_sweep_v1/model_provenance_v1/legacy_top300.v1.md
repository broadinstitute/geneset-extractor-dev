...
Legacy-style ranking with only the selected set size varied.
...
```bash
bash run/gtex_model_sweep_v1/run_model_legacy_top300.v1.sh
```

## Expected Outputs

- named_model_gmt_gz: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/legacy_top300/legacy_top300.v1.gmt.gz`
- comparison_to_reference_tsv: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/legacy_top300/comparison_to_reference.v1.tsv`
- comparison_to_reference_md: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/legacy_top300/comparison_to_reference.v1.md`

## Rationale

Tests whether a mildly broader library recovers legacy genes missed at top 200.
