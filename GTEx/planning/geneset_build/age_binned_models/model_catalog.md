# Age-Binned Model Catalog

## Scope

This file fulfills the age-binned model-catalog portion of [GTEx_model_plan.txt](/home/ryank/software/geneset_extractors/GTEx_model_plan.txt:1) from scratch, using only:
...
### AB1 `modern_auto_harmonizome_default`
...
### AB2 `harmonizome_auto_harmonizome_default`
...
### AB3 `harmonizome_limma_harmonizome_default`

- Proposal: `B`
- Intent: same as AB2, but forces the audit-friendly limma/voom backend when available
- Workflow:
  - `de_mode=harmonizome`
...
### AB4 `harmonizome_lightweight_explicit_harm_base`
...
### AB6 `harmonizome_lightweight_stat_top250`
...
### AB7 `harmonizome_lightweight_hybrid_top250`
...
### AB8 `harmonizome_lightweight_logfc_fdr005_lfc025`
...
### AB9 `harmonizome_lightweight_selected150`
...
- Expected effect on gene inclusion:
  ...
  - drops lower-ranked tail genes relative to AB4

### AB10 `harmonizome_lightweight_selected300`
...
### AB11 `harmonizome_lightweight_fdr001`
...
### AB12 `harmonizome_lightweight_fdr005_lfc050`
...
### AB13 `harmonizome_lightweight_fullrank250`
...
### AB14 `modern_lightweight_explicit_harm_sex`
...
### AB19 `harmonizome_lightweight_protein_coding_gtf`
...
### AB20 `harmonizome_lightweight_gtf_symbol_fallback`
...
### AB21 `harmonizome_limma_explicit_harm_sex`
...
### AB22 `modern_limma_explicit_harm_sex`
...
- Extractor:
  - same explicit settings as AB4
- Expected effect on gene inclusion:
  - compares backend and sample-balancing choices simultaneously against AB21 and AB14

## Exclusions From This Catalog

The following are intentionally not modeled in this planning bundle:
...
- batch-column sweeps: the current harmonizome preset disallows batch columns, and this planning bundle stays within verified, auditable GTEx bulk workflows.
...
## Output Files From This Planning Bundle
