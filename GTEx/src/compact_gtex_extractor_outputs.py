...
LONG_TOPK_PATTERN = re.compile(
    r"rna_deg_multi__comparison=(age\d+_\d+)__signature=(M\d+)__score_mode=[A-Za-z0-9_]+__(pos|neg|abs)__topk=\d+"
)
LONG_MASS_PATTERN = re.compile(
    r"rna_deg_multi__comparison=(age\d+_\d+)__signature=(M\d+)__score_mode=[A-Za-z0-9_]+__(pos|neg|abs)__hpd_mass=[A-Za-z0-9.]+__k=\d+"
)
LONG_BASE_PATTERN = re.compile(
    r"rna_deg_multi__comparison=(age\d+_\d+)__signature=(M\d+)__score_mode=[A-Za-z0-9_]+"
)
