...
def main():
    ...
    print(f"\nTop 10 comparisons by Jaccard distance (Up set):")
    up_set = successful_rows[successful_rows['gmt_set'] == 'Up'].sort_values('jaccard_distance', ascending=False)
    ...
    print(f"\nTop 10 comparisons by Jaccard distance (Down set):")
    down_set = successful_rows[successful_rows['gmt_set'] == 'Down'].sort_values('jaccard_distance', ascending=False)
