...
counts <- read.delim("/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/genesets/adipose_subcutaneous/models/AB3/workflow/backend_work/counts_gene_by_sample.tsv", check.names=FALSE)
meta <- read.delim("/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/genesets/adipose_subcutaneous/models/AB3/workflow/backend_work/metadata.tsv", check.names=FALSE)
comps <- read.delim("/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/genesets/adipose_subcutaneous/models/AB3/workflow/backend_work/comparisons.tsv", check.names=FALSE)
selected <- read.delim("/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/genesets/adipose_subcutaneous/models/AB3/workflow/backend_work/comparison_selected_samples.tsv", check.names=FALSE)
...
write.table(out, file="/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/genesets/adipose_subcutaneous/models/AB3/workflow/backend_work/deg_long.tsv", sep="	", row.names=FALSE, quote=FALSE)
