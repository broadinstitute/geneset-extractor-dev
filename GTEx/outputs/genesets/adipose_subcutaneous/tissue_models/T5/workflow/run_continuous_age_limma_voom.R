...
meta <- read.delim("/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/genesets/adipose_subcutaneous/tissue_models/T5/workflow/continuous_sample_metadata.tsv", check.names=FALSE)
...
write.table(tt, file="/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/genesets/adipose_subcutaneous/tissue_models/T5/tissue_extractor/tissue_deg.tsv", sep="\t", row.names=FALSE, quote=FALSE)
