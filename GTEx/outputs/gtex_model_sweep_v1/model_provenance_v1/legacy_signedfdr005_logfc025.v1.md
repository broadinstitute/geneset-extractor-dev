# legacy_signedfdr005_logfc025 v1

## Model Identity

- model_name: `legacy_signedfdr005_logfc025`
...
```bash
bash run/gtex_model_sweep_v1/run_model_legacy_signedfdr005_logfc025.v1.sh
```

## Expected Outputs

- named_model_gmt_gz: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/legacy_signedfdr005_logfc025/legacy_signedfdr005_logfc025.v1.gmt.gz`
- comparison_to_reference_tsv: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/legacy_signedfdr005_logfc025/comparison_to_reference.v1.tsv`
- comparison_to_reference_md: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/legacy_signedfdr005_logfc025/comparison_to_reference.v1.md`

## Rationale

Tests significance plus moderate effect-size gating.
