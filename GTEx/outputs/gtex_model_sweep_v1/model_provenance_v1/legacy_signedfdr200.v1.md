# legacy_signedfdr200 v1

## Model Identity

- model_name: `legacy_signedfdr200`
...
Legacy-style selection with the ranking rule varied while preserving the same DE workflow.
...
```bash
bash run/gtex_model_sweep_v1/run_model_legacy_signedfdr200.v1.sh
```

## Expected Outputs

- named_model_gmt_gz: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/legacy_signedfdr200/legacy_signedfdr200.v1.gmt.gz`
- comparison_to_reference_tsv: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/legacy_signedfdr200/comparison_to_reference.v1.tsv`
- comparison_to_reference_md: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/legacy_signedfdr200/comparison_to_reference.v1.md`

## Rationale

Tests FDR-driven directional ranking without switching to harmonizome mode.
