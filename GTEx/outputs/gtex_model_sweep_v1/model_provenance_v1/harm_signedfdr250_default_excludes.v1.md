# harm_signedfdr250_default_excludes v1
...
Keep harmonizome-style DE and ranking but re-enable default technical gene-family excludes.
...
```bash
bash run/gtex_model_sweep_v1/run_model_harm_signedfdr250_default_excludes.v1.sh
```

## Expected Outputs

- named_model_gmt_gz: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/harm_signedfdr250_default_excludes/harm_signedfdr250_default_excludes.v1.gmt.gz`
- comparison_to_reference_tsv: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/harm_signedfdr250_default_excludes/comparison_to_reference.v1.tsv`
- comparison_to_reference_md: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/harm_signedfdr250_default_excludes/comparison_to_reference.v1.md`

## Rationale

Tests whether harmonizome-mode technical-family inclusions are diluting biological specificity.
