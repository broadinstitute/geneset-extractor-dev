...
Harmonizome-style DE plus an explicit limma/voom backend for a statistically closer benchmark run.
...
```bash
bash run/gtex_model_sweep_v1/run_model_harm_signedfdr250_limma.v1.sh
```

## Expected Outputs

- named_model_gmt_gz: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/harm_signedfdr250_limma/harm_signedfdr250_limma.v1.gmt.gz`
- comparison_to_reference_tsv: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/harm_signedfdr250_limma/comparison_to_reference.v1.tsv`
- comparison_to_reference_md: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/harm_signedfdr250_limma/comparison_to_reference.v1.md`

## Rationale

Tests whether the lightweight backend is a material source of divergence from legacy Harmonizome behavior.
