# current_gtex_noharm_legacy200 v1
...
Current GTEx no-harmonizome baseline used in the existing GTEx rerun.
...
```bash
bash run/gtex_model_sweep_v1/run_model_current_gtex_noharm_legacy200.v1.sh
```

## Expected Outputs

- named_model_gmt_gz: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/current_gtex_noharm_legacy200/current_gtex_noharm_legacy200.v1.gmt.gz`
- comparison_to_reference_tsv: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/current_gtex_noharm_legacy200/comparison_to_reference.v1.tsv`
- comparison_to_reference_md: `/home/ryank/software/geneset_extractors/geneset-extractor-dev/GTEx/outputs/gtex_model_sweep_v1/models/current_gtex_noharm_legacy200/comparison_to_reference.v1.md`

## Rationale

Matches the existing gtex_no_harmonizome_analysis_v1 baseline and should be retained as the main comparator.
