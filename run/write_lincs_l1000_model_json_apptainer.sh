...
usage() {
  cat <<'EOF'
Usage:
  ./geneset-extractor-dev/run/write_lincs_l1000_model_json_apptainer.sh [run_lincs_l1000_hz_model.py args...]
  ./geneset-extractor-dev/run/write_lincs_l1000_model_json_apptainer.sh --help
EOF
}
...
RUNNER="${REPO_ROOT}/geneset-extractor-dev/LINCS_L1000/src/run_lincs_l1000_hz_model.py"
