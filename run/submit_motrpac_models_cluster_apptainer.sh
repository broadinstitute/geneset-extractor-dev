...
MOTRPAC_TRANSCRIPT_METADATA_TSV="${MOTRPAC_TRANSCRIPT_METADATA_TSV:-}"
MOTRPAC_PHENOTYPE_METADATA_TSV="${MOTRPAC_PHENOTYPE_METADATA_TSV:-}"
MOTRPAC_FEATURE_TO_GENE_TSV="${MOTRPAC_FEATURE_TO_GENE_TSV:-}"
MOTRPAC_RAT_TO_HUMAN_TSV="${MOTRPAC_RAT_TO_HUMAN_TSV:-}"
MOTRPAC_FEATURE_ANNOT="${MOTRPAC_FEATURE_ANNOT:-}"
MOTRPAC_DEA_DIR="${MOTRPAC_DEA_DIR:-}"
MOTRPAC_MAPPING_FILE="${MOTRPAC_MAPPING_FILE:-}"
