...
run_task_in_apptainer() {
  ...
  cmd+=("${APPTAINER_IMAGE}" bash "${BASH_SOURCE[0]}")

  echo "+ GENESET_EXTRACTORS_IN_APPTAINER=1 ${cmd[*]}"
  GENESET_EXTRACTORS_IN_APPTAINER=1 "${cmd[@]}"
}
