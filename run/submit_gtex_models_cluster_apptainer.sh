...
usage() {
  cat <<'EOF'
Usage:
  ./geneset-extractor-dev/run/submit_gtex_models_cluster_apptainer.sh --submit [--write_model_only|--refresh_metadata_and_provenance] [--model_group AB|AC|HZ] [--tissue_id TISSUE] [--model_id MODEL]
