...
| [submissions/remote-reproduction.md](submissions/remote-reproduction.md) | Adopters using a local coding host and remote/HPC execution host | Documents the portable authoring handoff, smoke-only authoring verification, explicit remote full reproduction, and final remote verification/submission. |
