...
| [submissions/adopting-trusted-existing-submission.md](submissions/adopting-trusted-existing-submission.md) | Maintainers adopting trusted legacy libraries | Chooser for four self-contained adoption tutorials; local authoring followed by remote full reproduction is the recommended mode. |
| [submissions/adopting-exact-reproduction-local-to-remote.md](submissions/adopting-exact-reproduction-local-to-remote.md) | Exact-reproduction adopters with HPC access | Complete local smoke-authoring, handoff, remote full-run, comparison, and submission procedure. |
| [submissions/adopting-scientific-reimplementation-local-to-remote.md](submissions/adopting-scientific-reimplementation-local-to-remote.md) | Scientific-reimplementation adopters with HPC access | Complete local authoring and remote scientific-comparability workflow, including remote input bindings and review gate. |
| [submissions/adopting-exact-reproduction-single-machine.md](submissions/adopting-exact-reproduction-single-machine.md) | Exact-reproduction adopters with local compute | Complete one-machine exact-reproduction procedure. |
| [submissions/adopting-scientific-reimplementation-single-machine.md](submissions/adopting-scientific-reimplementation-single-machine.md) | Scientific-reimplementation adopters with local compute | Complete one-machine scientific-reimplementation procedure. |
| [submissions/remote-reproduction.md](submissions/remote-reproduction.md) | Adopters using a local coding host and remote/HPC execution host | Documents local authoring, code-only handoff export, smoke-only authoring verification, explicit remote full reproduction, and final remote verification/submission. |
